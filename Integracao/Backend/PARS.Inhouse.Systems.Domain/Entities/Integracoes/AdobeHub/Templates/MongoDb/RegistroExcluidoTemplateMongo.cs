...
using PARS.Inhouse.Systems.Shared.DTOs.Integracoes.AdobeHub; // ✅ Import necessário para TipoTemplateResponseDto

namespace PARS.Inhouse.Systems.Domain.Entities.Integracoes.AdobeHub.Templates.MongoDb
{
    public class RegistroExcluidoTemplateMongo
    {
        /// <summary>
        ...
        /// <summary>
        /// Tipo do template - agora armazenado como objeto completo.
        /// </summary>
        public TipoTemplateRequestDto? Template { get; set; }
    }
}
